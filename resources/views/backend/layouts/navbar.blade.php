                    ...
                    <ul class="py-1" aria-labelledby="navNotifications">
                        ...
                        <a href="{{url('')}}/javascript:void(0);" class="dropdown-item">
                          <div class="flex">
                            <img class="object-cover rounded-full h-8 w-8 shrink-0 me-3"
                              src="{{url('')}}/assets/images/users/avatar-3.png" alt="logo" />
                            <div class="flex-grow flex-1 ms-0.5 overflow-hidden">
                              <p class="text-sm font-medium text-gray-900 truncate
                      ...
                      <li class="py-2 px-4">
                        <a href="{{url('')}}/javascript:void(0);" class="dropdown-item">
                          <div class="flex">
                            <img class="object-cover rounded-full h-8 w-8 shrink-0 me-3"
                              src="{{url('')}}/assets/images/users/avatar-9.png" alt="logo" />
                            <div class="flex-grow flex-1 ms-0.5 overflow-hidden">
                              <p class="text-sm font-medium  text-gray-900 truncate
                ...
                <div class="me-2  dropdown relative">
                  <button
                    ...
                    <img
                      ...
                      src="{{url('')}}/assets/images/users/avatar-1.png"
                      alt="user photo"
                      />
                    ...
                    <ul class="py-1" aria-labelledby="navUserdata">
                      ...
                      <li>
                          <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button style="margin-left:25px" class="flex items-center py-2 px-3 text-sm text-red-500 hover:bg-gray-50 hover:text-red-600
                          dark:text-red-500 dark:hover:bg-gray-900/20
                          dark:hover:text-red-500"><span data-lucide="power"
                                          class="w-4 h-4 inline-block text-red-500 dark:text-red-500 me-2"></span> Sign out</button>
                          </form>
                      </li>
                    </ul>
                  </div>
