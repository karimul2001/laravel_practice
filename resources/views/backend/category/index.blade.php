                                            ...
                                            <tbody>
                                                ...
                                                <form method="post" action="{{route('category.destroy', $category->id)}}">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{route('category.edit', $category->id)}}" class="border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white
                                                            px-3 py-1 rounded text-sm transition duration-200">
                                                            Edit
                                                        </a>

                                                           <!-- Delete Button -->
                                                        <button type='submit' class="border border-red-500 text-red-500 hover:bg-red-500 hover:text-white
                                                            px-3 py-1 rounded text-sm transition duration-200">
                                                            Delete
                                                        </button>
                                                    </td>
