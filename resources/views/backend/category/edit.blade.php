...
@endif
                            ...
                            <div class="flex-auto p-4 ">
                                <form method="post" action="{{route('category.update', $category->id)}}">
                                    ...
                                    <div class="mb-2">
                                        <label for="email"
                                            class="font-medium text-sm text-slate-600 dark:text-slate-400">Category Name
                                            </label>
                                        <input type="text" id="" name="category" value="{{!old('category')? $category->name : old('category')}}"
